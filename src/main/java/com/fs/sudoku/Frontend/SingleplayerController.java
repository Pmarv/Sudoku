...
public class SingleplayerController {
    ...
    private void handleMenuButton(ActionEvent actionEvent) {
        try {
            /*Resource testResource = chartController.getTest();
            if (testResource == null) {
                throw new NullPointerException("Test resource is null.");
            }*/
            FXMLLoader loader = new FXMLLoader(chartController.getTest().getURL());
